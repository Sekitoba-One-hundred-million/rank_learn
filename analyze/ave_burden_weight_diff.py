...
def main():
    ...
    for k in tqdm( race_data.keys() ):
        ...
        for kk in race_data[k].keys():
            ...
            burden_weight_list.append( cd.burden_weight() )

        if len( burden_weight_list ) == 0:
            continue

        ave_burden_weight = sum( burden_weight_list ) / len( burden_weight_list )
        ...
        for kk in race_data[k].keys():
            ...
            score = ave_burden_weight - cd.burden_weight()
            key = str( int( score ) )
